...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { description: @magazine.description, organisation_id: @magazine.organisation_id }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { description: @magazine.description, organisation_id: @magazine.organisation_id }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
