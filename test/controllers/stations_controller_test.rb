...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { description: @station.description, organisation_id: @station.organisation_id }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { description: @station.description, organisation_id: @station.organisation_id }
    assert_redirected_to station_path(assigns(:station))
  end
