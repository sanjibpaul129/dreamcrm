...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { business_unit_id: @block.business_unit_id, floors: @block.floors, name: @block.name, number: @block.number }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { business_unit_id: @block.business_unit_id, floors: @block.floors, name: @block.name, number: @block.number }
    assert_redirected_to block_path(assigns(:block))
  end
