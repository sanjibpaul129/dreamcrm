...
class ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post :create, channel: { description: @channel.description, organisation_id: @channel.organisation_id }
    end
  ...
  test "should update channel" do
    patch :update, id: @channel, channel: { description: @channel.description, organisation_id: @channel.organisation_id }
    assert_redirected_to channel_path(assigns(:channel))
  end
