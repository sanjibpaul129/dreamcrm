...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { company_id: @work_order.company_id, date: @work_order.date, vendor_id: @work_order.vendor_id }
    end
  ...
  test "should update work_order" do
    patch :update, id: @work_order, work_order: { company_id: @work_order.company_id, date: @work_order.date, vendor_id: @work_order.vendor_id }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
