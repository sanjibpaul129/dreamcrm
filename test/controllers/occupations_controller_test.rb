...
class OccupationsControllerTest < ActionController::TestCase
  ...
  test "should create occupation" do
    assert_difference('Occupation.count') do
      post :create, occupation: { description: @occupation.description, organisation_id: @occupation.organisation_id }
    end
  ...
  test "should update occupation" do
    patch :update, id: @occupation, occupation: { description: @occupation.description, organisation_id: @occupation.organisation_id }
    assert_redirected_to occupation_path(assigns(:occupation))
  end
