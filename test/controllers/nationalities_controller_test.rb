...
class NationalitiesControllerTest < ActionController::TestCase
  ...
  test "should create nationality" do
    assert_difference('Nationality.count') do
      post :create, nationality: { description: @nationality.description, organisation_id: @nationality.organisation_id }
    end
  ...
  test "should update nationality" do
    patch :update, id: @nationality, nationality: { description: @nationality.description, organisation_id: @nationality.organisation_id }
    assert_redirected_to nationality_path(assigns(:nationality))
  end
